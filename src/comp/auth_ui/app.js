...
class AuthUI extends Component {
  ...
  handlePage = (page) => this.props.openModal(page);
  handleLogout = () => this.props.logout();
  handleSiteURL = (url) => this.props.setSiteURL(url);
  clearSiteURL = (url) => this.props.clearSiteURL();
  clearStoreError = () => this.props.setError();
  handleExternalLogin = (provider) => this.props.externalLogin(provider);
  ...
  render() {
    const { store } = this.props;
    const _page = "login"
    const showHeader = pagesWithHeader["login"];
